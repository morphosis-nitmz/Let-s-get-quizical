...
try{
   ...
   if((int)session.getAttribute("q13")==1)
	    response.sendRedirect("logout");
	    
	else session.setAttribute("q13", 1);
   }
}
catch (Exception e) {
...
{
	//calculate score
	 check=  CalScore.calScore(user,12,answer2);
	 if(check==true)
	  {
		  %>
...
<div class="container">
	...
	<h2>What is the theme of the 2019 edition of World Red Cross Day (WRCD)?</h2>
	 <form name="options" action="ques14" method="post">
  <ul>
 
  <li>
  
    <input type="radio" id="f-option" name="answer" value="peace">
    <label for="f-option">peace</label>
    
    <div class="check"></div>
  </li>
  
  <li>
    <input type="radio" id="s-option" name="answer" value="love">
    <label for="s-option">love</label>
    
    <div class="check"><div class="inside"></div></div>
  </li>
  
  <li>
    <input type="radio" id="t-option" name="answer" value="humanity">
    <label for="t-option">humanity</label>
   ...
   <li>
    <input type="radio" id="u-option" name="answer" value="unity">
    <label for="u-option">unity</label>
