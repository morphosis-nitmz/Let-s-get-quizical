...
try{
   ...
   if((int)session.getAttribute("q11")==1)
	    response.sendRedirect("logout");
	    
	else session.setAttribute("q11", 1);
   }
}
catch (Exception e) {
...
{
	//calculate score
	 check=  CalScore.calScore(user,10,answer2);
	 if(check==true)
	  {
		  %>
...
<div class="container">
	...
	<h2>WHICH CYLONE CURRENTLY CAME OVER BAY OF BENGAL?</h2>
	 <form name="options" action="ques12" method="post">
  <ul>
 
  <li>
  
    <input type="radio" id="f-option" name="answer" value="IRMA">
    <label for="f-option">IRMA</label>
    
    <div class="check"></div>
  </li>
  
  <li>
    <input type="radio" id="s-option" name="answer" value="VARDAH">
    <label for="s-option">VARDAH</label>
    
    <div class="check"><div class="inside"></div></div>
  </li>
  
  <li>
    <input type="radio" id="t-option" name="answer" value="WILMA">
    <label for="t-option">WILMA</label>
   ...
   <li>
    <input type="radio" id="u-option" name="answer" value="FANI">
    <label for="u-option">FANI</label>
