...
try{
   ...
   if((int)session.getAttribute("q10")==1)
	    response.sendRedirect("logout");
	    
	else session.setAttribute("q10", 1);
   }
}
catch (Exception e) {
...
{
	//calculate score
	 check=  CalScore.calScore(user,9,answer2);
	 if(check==true)
	  {
		  %>
...
<div class="container">
	...
	<h2>WHICH COUNTRY STARTED FIRST PLASTIC NOTES?</h2>
	 <form name="options" action="score" method="post">
  <ul>
 
  <li>
  
    <input type="radio" id="f-option" name="answer" value="NEW ZEALAND">
    <label for="f-option">NEW ZEALAND</label>
    
    <div class="check"></div>
  </li>
  
  <li>
    <input type="radio" id="s-option" name="answer" value="AUSTRALIA">
    <label for="s-option">AUSTRALIA</label>
    
    <div class="check"><div class="inside"></div></div>
  </li>
  
  <li>
    <input type="radio" id="t-option" name="answer" value="JAPAN">
    <label for="t-option">JAPAN</label>
   ...
   <li>
    <input type="radio" id="u-option" name="answer" value="INDONESIA">
    <label for="u-option">INDONESIA</label>
