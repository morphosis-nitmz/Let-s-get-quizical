...
logindao dao = new logindao();
	...
	if(dao.check(leader, pass)) {
		...
		session.setAttribute("q4",0);
		session.setAttribute("q5",0);
		session.setAttribute("q6",0);
		session.setAttribute("q7",0);
		session.setAttribute("q8",0);
		session.setAttribute("q9",0);
		session.setAttribute("q10",0);
		session.setAttribute("q11",0);
		session.setAttribute("q12",0);
		session.setAttribute("q13",0);
		session.setAttribute("q14",0);
		session.setAttribute("q15",0);
