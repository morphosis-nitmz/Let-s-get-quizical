...
try{
   ...
   if((int)session.getAttribute("q5")==1)
	    response.sendRedirect("logout");
	    
	else session.setAttribute("q5", 1);
   }
}
catch (Exception e) {
...
if(answer2!=null)
{
	 check=  CalScore.calScore(user,4,answer2);
	 if(check==true)
	  {
		  %>
...
<div class="container">
	...
	<h2>Which of the following state city police has launched an all-women police patrol unit 'Rani Abbakka Force'?</h2>
	 <form name="options" action="ques6" method="post">
  <ul>
 
  <li>
  
    <input type="radio" id="f-option" name="answer" value="Karnataka">
    <label for="f-option">Karnataka</label>
    
    <div class="check"></div>
  </li>
  
  <li>
    <input type="radio" id="s-option" name="answer" value="Tamil Nadu">
    <label for="s-option">Tamil Nadu</label>
    
    <div class="check"><div class="inside"></div></div>
  </li>
  
  <li>
    <input type="radio" id="t-option" name="answer" value="Kerala">
    <label for="t-option">Kerala</label>
   ...
   <li>
    <input type="radio" id="u-option" name="answer" value="Andhra Pradesh">
    <label for="u-option">Andhra Pradesh</label>
